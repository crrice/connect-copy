...
let sourceClientInstance: ConnectClient | null = null;
let targetClientInstance: ConnectClient | null = null;


export function getSourceClient(): ConnectClient {
...
export function getTargetClient(): ConnectClient {
...
export function getClient(instanceId: string): ConnectClient {
